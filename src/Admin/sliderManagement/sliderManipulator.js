...
class SlideManipulation extends Component {
    state = {
        Instructions: "Inst",
        DataList: [],
        List: [],
    ...
    delete=(id)=> {
        alert(id);
        axios.get('http://localhost:4000/slider/delete/'+ id)
    ...
    Edit=(id)=> {
        ...
        alert(id);
        axios.get('http://localhost:4000/slider/edit/'+ id)
            .then(console.log('Deleted'))
            .catch(err => console.log(err))
    }
...
export default SlideManipulation;