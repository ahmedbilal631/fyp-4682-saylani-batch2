...
class AdminManipulation extends Component {
    state = {
        DataList: [],
        List: [],
        session: 0
   ...
   constructor(props) {
    ...
    delete=(id)=> {
        alert(id);
        axios.get('http://localhost:4000/auth/delete/'+ id)
    ...
    Edit=(id)=> {
        ...
        alert(id);
        axios.get('http://localhost:4000/auth/edit/'+ id)
            .then(console.log('Deleted'))
            .catch(err => console.log(err))
    }
    ...
    render() {
        ...
        return (
            ...
            <br/><br/>
            <br/><br/>
                <h3 className="quickLinks text-light">Admin Management</h3>
                <br />
                    ...
                    <tr className="ctmHeadingCenter">
                        ...
                        {this.state.DataList.map((n, i) => {
                            return (
                                <tbody>
                                    <tr key={i}>
                                    <td className="ctmHeading">{n.Name}</td>
                                    <td>{n.Password}</td>                                    
                                    <td>{n._id}</td>
...
export default AdminManipulation;