...
class UGAdmission extends Component {
  render() {
    return (
      <div className="ctmBgTeal">
          ...
          <p className="ctmHeadingCenter text-black" id="school">Undergraduate admission!</p>
          ...
          <p className="ctmClrBlack ctmBold">Download Form Now : <Link to="#">Download</Link></p>
          <hr/>
          <br/><br/>
