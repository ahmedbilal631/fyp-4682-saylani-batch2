...
class SlideUploader extends Component {
    state = {
    ...
    onSubmit = () => {
        ...
        axios.post('http://localhost:4000/slider/add', obj)
                ...
                <div className="contactBg">
                    <div className="row">
                        ...
                        <div className="container col-sm-4">
                            <br />
                            <p className="contactFormHeading text-light">Instructions For You!!</p>
                        ...
                        <div className="col-sm-5">
                            ...
                            <div className="customBgFrom" >
                                ...
                                <form action="/employee" onSubmit={this.onSubmit} autoComplete="false">
                                    <p className="contactFormHeading">Slide Upload!</p>
                                    <p className="text-danger" >{this.state.Instructions}!</p>
