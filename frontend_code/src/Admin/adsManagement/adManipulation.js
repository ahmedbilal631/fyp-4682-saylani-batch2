...
class AdManipulation extends Component {
    state = {
        DataList: [],
        List: [],
        session: 0
   ...
   constructor(props) {
    ...
    delete=(id)=> {
        alert(id);
        axios.get('http://localhost:4000/ads/delete/'+ id)
    ...
    Edit=(id)=> {
        ...
        alert(id);
        axios.get('http://localhost:4000/ads/edit/'+ id)
            .then(console.log('Deleted'))
            .catch(err => console.log(err))
    }
    ...
    render() {
        ...
        return (
            ...
            <br/><br/>
            <br/><br/>
                <h3 className="quickLinks text-light">Ads</h3>
                <br />
                        ...
                        {this.state.DataList.map((n, i) => {
                            return (
                                <tbody>
                                    ...
                                    <td>{n.ImgUrl}</td>
                                    <td>{n._id}</td>
                                    <td><Link to="/adEdit"><button onClick={()=>{this.Edit(n._id)}} className="btn btn-primary">Edit</button></Link></td>
